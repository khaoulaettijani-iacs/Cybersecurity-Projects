...
- Problem analysis and reconnaissance
...
|----------|---------------------|
| **Web** | SQLi, XSS, IDOR, LFI/RFI, Auth Bypass |
| **Crypto** | Cryptanalysis, Encoding schemes |
| **Forensics** | File analysis, Memory dumps, PCAP analysis |
| **Network** | Traffic analysis, Protocol exploitation |
